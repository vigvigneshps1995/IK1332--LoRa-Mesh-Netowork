...
def receive(lclient):
    ...
    for i in range(100):
        ...
        rssi.append(lclient.packet_rssi())
        snr.append(lclient.packet_snr())
        print (lclient.rssi())
...
if __name__ == "__main__":
    ...
    #print (lora_client.dump_registers())
    rssi, snr = receive(lora_client)
    print ("Average RSSI: ", sum(rssi)/len(rssi))
    print ("Average SNR: ", sum(snr)/len(snr))
